...
insert into restaurant_request (category_id, campus_id, name, member_id, registered, created_at)
values (1, 2, '마담밍4', 1, true, current_timestamp);
insert into restaurant_request (category_id, campus_id, name, member_id, created_at)
values (2, 2, '마담밍5', 2, current_timestamp);
insert into restaurant_request (category_id, campus_id, name, member_id, created_at)
values (1, 2, '마담밍6', 1, current_timestamp);
